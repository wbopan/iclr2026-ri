...
This inaccuracy is evidenced in \S\ref{sec:refusal_index_validation}: if the same model exhibits different refusal rates, these combinations return varying and biased scores.
...
In \S\ref{sec:refusal_index_validation}, we first demonstrate how RI quantifies the capability of models to refuse questions they don't know. 
